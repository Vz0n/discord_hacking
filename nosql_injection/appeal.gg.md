...
This, chained with the Sapphire bug could allow you to read appeals sent by other users. Note that you don't need to be able to submit appeals to exploit this.
